    ...
    return{
        addItem:function(type,dec,val){
            ...
            if(data.allItems[type].length>0)
                ...
                ID=0;
            //Create new item, eather Expense or Income(inc, exp)
            if(type==='exp')
            {
...
var UIController=(function(){
    ...
    return {
        ...
        displayBudget:function(obj)
        {
            ...
            document.querySelector(DOMString.expenseLabel).textContent=formatNumber(obj.totalExpenses,'exp');
